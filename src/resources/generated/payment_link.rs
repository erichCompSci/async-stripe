...
impl PaymentLink {
    ...
    pub fn create(client: &Client, params: CreatePaymentLink<'_>, idempotency_key: Option<&str>) -> Response<PaymentLink> {
        client.post_form("/payment_links", &params, idempotency_key)
    }
    ...
    pub fn update(client: &Client, id: &PaymentLinkId, params: UpdatePaymentLink<'_>, idempotency_key: Option<&str>) -> Response<PaymentLink> {
        client.post_form(&format!("/payment_links/{}", id), &params, idempotency_key)
    }
}
